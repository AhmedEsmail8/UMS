...
public:
    ...
    void setupUi(QDialog *FinishedCourses)
    {
        ...
        FinishedCourses->setStyleSheet(QString::fromUtf8("border-image: url(white.png);"));
...
"}"));
        ...
        pushButton_30->setStyleSheet(QString::fromUtf8("border-image: url(white.png);\n"
"padding:18px;\n"
"font: 900 11pt \"Arial Black\";\n"
"text-align:left;\n"
"color:rgb(103,58,183);"));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 884, 566));
