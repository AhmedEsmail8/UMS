...
public:
    ...
    void setupUi(QDialog *PendingRequests)
    {
        ...
        PendingRequests->setStyleSheet(QString::fromUtf8("border-image: url(C:/Users/Hema/Desktop/Project/white.png);"));
...
"}"));
        ...
        pushButton_46->setStyleSheet(QString::fromUtf8("border-image: url(C:/Users/Hema/Desktop/Project/white.png);\n"
"padding:18px;\n"
"font: 900 11pt \"Arial Black\";\n"
"text-align:left;\n"
"border-top-left-radius:30px;\n"
...
"}"));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 867, 580));
